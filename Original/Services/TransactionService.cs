...
namespace Services
{
    public class TransactionService : ITransactionService
    {
        ...
        public async Task<LineGraphDataAverage> GetLast12MonthBalancesWithAverage(string? userId)
        {
            // Object to contain the line graph data
            var lineGraphData = new LineGraphDataAverage();
            ...
            if (allTransactions.Count() > 0)
            {
                ...
                lineGraphData.Average = Math.Round(lineGraphData.Figures.Sum() / 12, 2);
            }
            // returning the line graph data object
            return lineGraphData;
        }
